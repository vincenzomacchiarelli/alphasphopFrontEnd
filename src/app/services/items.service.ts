...
export class ItemsService {
    ...
    articoli: IArticoli[] = [
      ...
      {codart : "013500121", descrizione : "BARILLA PASTA GR.500 N.70 1/2 PENNE", um : "PZ", pzcart : 30, peso : 0.5, prezzo : 1.3, active : false, data : new Date(), imageUrl: 'assets/images/prodotti/013500121.jpg'},
      ...
      {codart : "007686402", descrizione : "FINDUS FIOR DI NASELLO 300 GR", um : "PZ", pzcart : 8, peso : 0.3, prezzo : 6.46, active : false, data : new Date(), imageUrl: 'assets/images/prodotti/007686402.jpg'},
  ...
  getArticoliByCode = (codart: string) : IArticoli => {
    const index = this.articoli.findIndex((item) => item.codart === codart);
